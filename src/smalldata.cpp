...
//
//  ★★ 无实测表面图的处理 (关乎严谨性):
//    阅神星、妊神星、鸟神星以及多数小彗核至今**没有分辨率足够的全球图**。
//    这些天体的 texture 设为 nullptr, 由渲染器画成**均匀色球**
...
//
//  ★★ 关于历元 (这是本项目踩过的最隐蔽的坑):
//    JPL 给出的 L (平黄经) 是**在该天体自己的历元上**的, 而各天体历元
...
},
{
    ...
    BodyType::Moon,
    "阴阳脸 + 赤道巨脊, 且**轨道面相对土星赤道倾斜 15.5°** —— 轨道倾角不可用圆轨道近似。",
},
...
{
    {
        ...
        /* atmo              */ false, {0.0f, 0.0f, 0.0f}, 0.0, 0.0,
        /* moon-orbit a/e/i  */ 0.0, 0.0, 0.0,
        /* desc              */ "主带第二大天体, 密度 3.46 说明它是**分化过的**: "
...
{
    {
        ...
        /* desc              */ "近地小行星 (轨道可进入火星轨道内侧)。"
                               "NEAR Shoemaker 于 2001 年在此**首次着陆小行星**, "
...
{
    {
        ...
        /* atmo              */ false, {0.0f, 0.0f, 0.0f}, 0.0, 0.0,
        /* moon-orbit a/e/i  */ 0.0, 0.0, 0.0,
        /* desc              */ "欧空局 Rosetta 任务的目标: 2014 年成为**首个被探测器环绕的彗星**, "
...
{
    {
        ...
        /* desc              */ "NASA Stardust 任务于 2004 年穿越其彗发并采集尘埃, "
                               ...
                               "以及**只有在极高温下才能形成的晶体** —— 说明彗星物质曾经历内太阳系的高温。",
    },
    BodyType::Comet,
