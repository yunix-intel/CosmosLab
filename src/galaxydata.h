...
inline const char *kNotes[] = {
    ...
    "太阳位于猎户支内侧, 距银心约 2.658 万光年 (8.15 kpc), "
    "以约 236 km/s 绕银心运行。"
    ...
    "银心的人马座 A\\* (Sgr A\\*) 是超大质量黑洞, 质量约 430 万倍太阳质量, "
    "2022 年由事件视界望远镜首次成像。",
    ...
    "★ 每条臂的螺距角各不相同 (8.7°~19.5°), 且多数臂带“折点”: "
    "折点两侧螺距角不同。用统一的俯仰角描述是过度简化。",

    "★ 关于图层: 画面中半透明的背景图是 NASA/JPL 发布的银河系结构"
    "科学插画 (作者 Robert Hurt, 依据 Spitzer 红外与 CO 观测绘制), "
    "不是照片 —— 我们身处银盘内部, 外部全景在物理上无法拍到。"
    "其上的粒子是按 Reid 2019 参数生成的 3D 示意模型。",
